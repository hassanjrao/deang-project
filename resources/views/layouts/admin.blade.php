    ...
    <div id="page-container"
        ...
        <aside id="side-overlay" class="fs-sm">
            ...
            <div class="content-header border-bottom">
                ...
                <!-- User Info -->
                <div class="ms-2">
                    <a class="text-dark fw-semibold fs-sm" href="javascript:void(0)">{{ ucfirst(Auth::user()->name) }}</a>
                </div>
                <!-- END User Info -->
                ...
                <div class="content-side">
                    <ul class="nav-main">
                        ...
                        <li class="nav-main-item">
                            <a class="nav-main-link{{ request()->is('admin/dashboard') ? ' active' : '' }}{{ request()->is('admin') ? ' active' : '' }}"
                ...
                <div class="d-flex align-items-center">
                    ...
                    <div class="dropdown d-inline-block ms-2">
                        <button type="button" class="btn btn-sm btn-alt-secondary d-flex align-items-center"
                            ...
                            <span class="d-none d-sm-inline-block ms-2">{{ ucfirst(Auth::user()->name) }}</span>
                        ...
                        <div class="dropdown-menu dropdown-menu-md dropdown-menu-end p-0 border-0"
                            ...
                            <div class="p-3 text-center bg-body-light border-bottom rounded-top">
                                ...
                                <p class="mt-2 mb-0 fw-medium">{{ ucfirst(Auth::user()->name) }}</p>
